...
app.get("/work", (req, res) => {
  const workdata = [
    { id: 1, title: "코드카타 풀기", date: "2024-06-01" },
    { id: 1, title: "TIL 쓰기", date: "2024-06-01" },
    { id: 1, title: "강의 복습하기", date: "2024-06-01" },
    { id: 1, title: "연습문제 풀어보기", date: "2024-06-01" },
  ];
  res.send(workdata);
});
...
app.get("/work/:userId", (req, res) => {
  ...
  const workdata = [
    { id: 1, title: "코드카타 풀기", date: "2024-06-01" },
    { id: 2, title: "TIL 쓰기", date: "2024-06-01" },
    { id: 3, title: "강의 복습하기", date: "2024-06-01" },
    { id: 4, title: "연습문제 풀어보기", date: "2024-06-01" },
  ];

...
const marguerite1 = new Marguerite('마가렛', 4);
...
console.log('데이지1은 플라워의 인스턴스', daisy1 instanceof Flower); //true
console.log('데이지1은 마가렛의 인스턴스', daisy1 instanceof Marguerite); //false
console.log('-------------------');
